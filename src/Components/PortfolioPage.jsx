...
const PortfolioPage = () => {
  ...
  return (
    <div className='md:min-h-[100vh] lg:min-h-[150vh] bg-[#F0F3F3] w-full flex flex-col items-center justify-center gap-19 pt-10 font-lato md:pb-7 lg:pb-16' >
         <HeadingWithStar bg={Arr} >
          Our Portfolio
        </HeadingWithStar>
        <div className='w-3/4   md:min-h-[90vh] lg:min-h-[120vh]' >
           <HexagonPage/>
        </div>
        <div className='w-3/4  lg:h-20 flex items-center justify-center md:mt-0 lg:mt-10' >
